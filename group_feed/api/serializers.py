...
class LinkSerializer(serializers.ModelSerializer):
    ...
    def get_comments(self, obj):
        # return Comment.objects.filter(link=obj, parent__isnull=True).values()
        return Comment.objects.filter(link=obj).values()
...
#     CommentSerializer.base_fields['parent'] = CommentSerializer()
#     CommentSerializer.base_fields['children'] = CommentSerializer(many=True)
#
#     class Meta:
#         model = Comment
